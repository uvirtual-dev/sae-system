  ...
  return state.selectedItem !== null && state.selectedItem !== undefined ? (
    <div className="app-user-view">
          <Breadcrumb>
            ...
            <BreadcrumbItem>
              <Link to='/modules/program/list'> Programa </Link>
            </BreadcrumbItem>
            <BreadcrumbItem>
              <Link to={`/modules/version/list/${state.currentProgram}`}> Version </Link>
            </BreadcrumbItem>
    ...
    <div className='app-general-list'>
      <Alert color="danger">
        ...
        <div className="alert-body">
          ...
          <Link to="/modules/user/list">la lista de items</Link>
        </div>
      </Alert>
      <CustomFooter />
    </div>
